            ...
            if userDst <= 15 then
                ...
                if userDst <= 5 then
                    ...
                    if userDst <= 1.5 then
                        ...
                        ESX.TriggerServerCallback('werstbay-npcdoctor:parakontrol1', function(hasEnoughMoney)
                            if hasEnoughMoney then
                                TriggerServerEvent('werstbay-plasticsurgery:skin')
                                ESX.ShowNotification('Estetik operasyonu başlıyor!')
                                TriggerServerEvent('werstbay-npcdoctor:money1')
                            else
